...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 800, "IndexBuffer", NULL, NULL);
    ...
    GLfloat vertices[] =
    {
        ...
        -0.5f / 2, 0.5f * sqrtf(3) / 6, 0.0f, // Inner left
        0.5f / 2, 0.5f * sqrtf(3) / 6, 0.0f, // Inner right
        0.0f, -0.5f * sqrtf(3) / 3, 0.0f // Inner down
    };
